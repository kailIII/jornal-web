package br.jornal.service.impl;
...
import br.jornal.enumerations.QueryType;
import br.jornal.repository.GenericRepository;
import br.jornal.service.GenericService;
...
public class GenericServiceImpl<T> implements GenericService<T> {
	...
	public List find(QueryType type, String query,
		...
		return repository.find(type, query, namedParams, firstResult,
				maxResults);
	}
